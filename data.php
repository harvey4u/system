    ...
    <div class="sidebar">
      ...
      <?php 
        if(isset($_SESSION['Profile_picture']) && !empty($_SESSION['Profile_picture'])){
          $Profile_pic = "../examples/upload/" . $_SESSION['Profile_picture'];
        }else{
          $Profile_pic =  "../examples/upload/default.jpg";
        }
      ?>
        ...
        <div class="info">
          <a href="../examples/profile.php" class="d-block"><?php echo $_SESSION['fname']. ' ' . $_SESSION['mname']. ' ' . $_SESSION['lname'];?></a>
        </div>
      </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#" id="addCourse">Add</a></li>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group row">
                    <label for="inputphonenumber" class="col-sm-3 col-form-label">Course ID</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group row">
                    <label for="inputphonenumber" class="col-sm-3 col-form-label">Title</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group row">
                    <label for="inputphonenumber" class="col-sm-3 col-form-label">Department</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group row">
                    <label for="inputphonenumber" class="col-sm-3 col-form-label">Credits</label>
                    <div class="col-sm-9">
